...
export const zh = {
  ...
  'estimator.provider.placeholder': '留空则跟随会话默认模型',
  'estimator.baseUrl': '端点地址（/v1）',
  'estimator.model': '模型',
  'estimator.apiKey': 'API Key（仅写入，不回显）',
  'estimator.apiKey.placeholder': '已配置则留空保持不变',
...
export const en = {
  ...
  'estimator.provider.placeholder': 'Empty follows the session default model',
  'estimator.baseUrl': 'Endpoint base URL (/v1)',
  'estimator.model': 'Model',
  'estimator.apiKey': 'API key (write-only, never echoed)',
  'estimator.apiKey.placeholder': 'Leave empty to keep the stored key',
